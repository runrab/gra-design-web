  ...
  <a-card :bordered="false">
    <a-tabs defaultActiveKey="1">
      ...
      <a-tab-pane tab="柱状图" key="1">
        <bar title="人数排行" :dataSource="barData" :height="height"/>
      </a-tab-pane>
      <!-- 多列柱状图 -->
      ...
      <a-tab-pane tab="面积图" key="4">
        <area-chart-ty title="人数排行" :dataSource="areaData" x="月份" y="人数" :height="height"/>
      </a-tab-pane>
      <!-- 迷你面积图 -->
      <a-tab-pane tab="迷你面积图" key="5">
        <div style="padding-top: 100px;width:600px;height:200px">
          <mini-area :dataSource="areaData" x="月份" y="人数" :height="height"/>
        </div>
      </a-tab-pane>
      <!-- 多行折线图 -->
      ...
      <a-tab-pane tab="排名列表" key="11">
        <rank-list title="热门城市排行榜" :list="rankList" style="width: 600px;margin: 0 auto;"/>
      </a-tab-pane>
      <!-- TransferBar -->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      loadRankListData() {
        this.rankList = this.loadData('name', 'total', 2000, 100, '北京朝阳 ', ' 号市')
      }
    }
  }
</script>
